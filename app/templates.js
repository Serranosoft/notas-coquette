...
export default function Templates() {
    ...
    const TEMPLATES = [
        {
            title: language.t("_tplWeeklyPlanner"),
        ...
        {
            title: language.t("_tplWonyoungismDiscipline"),
        ...
        {
            title: language.t("_tplWonyoungismGlowUp"),
            id: 'tpl-glow-up',
        ...
        {
            title: language.t("_tplStudyFocus"),
            id: 'tpl-study-notes',
